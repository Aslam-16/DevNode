...
🟢JWT - install cookie-parser,jwt - use jwtsign at the login page and send the cook as response - while accessing any protected route, verify the jwt token from cookie and get the userinfo to proceed the operation of that route.
